class Fluxo
    ...
    def validacao_fluxo(valida_fluxo)
        ...
        when 'Unico plano'
            Comum.new.titulo_existe_popup('Como eu posso te ajudar?')

        when 'Mais de um plano'
            Comum.new.titulo_existe_popup('Teste, você quer atendimento para qual plano?')

        when 'Carteirinha - NOVA'
            Comum.new.texto_existe('Agora, sua carteirinha também é digital.') 
            Comum.new.texto_existe('Ela tem a mesma validade que a carteirinha física e também é aceita por todos os prestadores da nossa rede credenciada.')
            Comum.new.texto_existe('Deseja visualizar sua carteirinha ou pedir a segunda via da versão física?')
        ...
        when 'Else token'
            Comum.new.texto_existe('Não entendi a sua resposta. Se não tiver recebido o código, digite não recebi.')
            Comum.new.texto_existe('Se quiser encerrar a conversa, é só dgitar sair.')

        when 'Else token segunda tentativa'
            Comum.new.texto_existe('Ainda não consegui entender e vou encerrar a conversa.')
            Comum.new.texto_existe('Quando precisar, é só chamar 🙂')
        ...
        when 'Menos que sete numeros'
            Comum.new.titulo_existe_popup('Para dar continuidade ao atendimento, preciso que você me informe um código de acesso.')
            Comum.new.titulo_existe_popup('Como posso te enviar?')
        ...
        when 'Mais opções'
            Comum.new.texto_existe('Para dar continuidade ao atendimento, preciso que você me informe um código de acesso. Como posso te enviar?')
 ...
 #####################################Carteirinha##################################
    ...
    def redirecionamento_fluxo(fluxo, massa)
        ...
        when 'Nome social'
            ...
            Comum.new.selecionar_reply('NÃO')
            #Comum.new.clica_enviar
            ...
            Comum.new.clica_enviar
            Comum.new.texto_existe('Certo, podemos prosseguir te chamando de, Teste.')
            Comum.new.selecionar_reply('SIM')
            #Comum.new.clica_enviar
        ...
        when 'Mais de um plano'
            ...
            Comum.new.selecionar_opcao_web('Plano 1')
        ...
        when 'Carteirinha'
            redirecionamento_fluxo('Inicio', massa)
            validacao_fluxo('Unico plano')
            Comum.new.selecionar_opcao_web('Carteirinha')
